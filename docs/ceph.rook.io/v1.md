...
| storage | A spec for available storage in the cluster and how it should be used | [rookiov1.StorageScopeSpec](https://pkg.go.dev/github.com/rook/rook/pkg/apis/rook.io/v1#StorageScopeSpec) | false |
| annotations | The annotations-related configuration to add/set on each Pod related object. | [rookiov1.AnnotationsSpec](https://pkg.go.dev/github.com/rook/rook/pkg/apis/rook.io/v1#AnnotationsSpec) | false |
| labels | The labels-related configuration to add/set on each Pod related object. | [rookiov1.LabelsSpec](https://pkg.go.dev/github.com/rook/rook/pkg/apis/rook.io/v1#LabelsSpec) | false |
| placement | The placement-related configuration to pass to kubernetes (affinity, node selector, tolerations). | [rookiov1.PlacementSpec](https://pkg.go.dev/github.com/rook/rook/pkg/apis/rook.io/v1#PlacementSpec) | false |
| network | Network related configuration | [NetworkSpec](#networkspec) | false |
| resources | Resources set resource requests and limits | [rookiov1.ResourceSpec](https://pkg.go.dev/github.com/rook/rook/pkg/apis/rook.io/v1#ResourceSpec) | false |
| priorityClassNames | PriorityClassNames sets priority classes on components | [rookiov1.PriorityClassNamesSpec](https://pkg.go.dev/github.com/rook/rook/pkg/apis/rook.io/v1#PriorityClassNamesSpec) | false |
